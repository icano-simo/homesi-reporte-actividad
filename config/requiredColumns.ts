...
// (OPTIONAL_COLUMNS[1]/[2]/[3]/[4]/[5]), igual que ya hacía con Total Loan
// Amount en el índice 0. Si agregás una columna opcional nueva, agregala al
// final.
//
...
//
// [5] 'HELOC LIEN POSITION' -- header exacto confirmado contra el archivo
// real de SL Query. Opcional por el mismo motivo que [4]: un archivo que no
// la traiga no debe romper el parseo, simplemente ningún loan de ese archivo
// queda excluido por esta regla (ver lib/domain/isHelocLien2.ts).
