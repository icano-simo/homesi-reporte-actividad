 ...
 * ============================================================================
 *
 * Etapa AUTH1 — ARCHIVO NUEVO. Equivalente a `lib/supabase-middleware.ts` de
 * homesi-pl.
 *
 ...
 *
 * Por eso el helper devuelve `response()` — que construye una respuesta con
 * las cookies actualizadas ya puestas — y `withAuthCookies()`, para el caso de
 * los redirects, donde la respuesta la crea Next y hay que trasladarle esas
 * mismas cookies a mano.
 */
    ...
    process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!,
    {
      cookies: {
        ...
        setAll(newCookies) {
          ...
          // vuelve a leer la cookie, tiene que ver el valor renovado y no el
          // viejo.
 ...
 * que haya ocurrido durante el chequeo se pierde justo en las rutas que más
 * redirigen (login, no-access), y la sesión queda a medio renovar.
 */
